<template>
  <div>
    <Header title="It's Empty Here" bgImage="notfound.jpg" position="right" />
    <div class="h-[50dvh] flex items-center justify-center bg-gray-50">
      <div class="text-center">
        ...
        <router-link
          to="/"
          class="inline-flex items-center px-6 py-3 bg-[#339e3f] text-white rounded-lg hover:bg-[#2b843a] transition-colors"
        >
